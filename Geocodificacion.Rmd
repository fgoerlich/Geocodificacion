...
knitr::include_graphics("./Geocodificacion_files/img/01_MonoFRA.jpg")
```
...
```{r, echo = FALSE, eval = TRUE, fig.asp = 2/2, out.width = "100%", fig.align = "center"}
knitr::include_graphics("./Geocodificacion_files/img/02_NoGeo.jpg")
```
...
```{r, echo = FALSE, eval = TRUE, fig.asp = 2/2, out.width = "100%", fig.align = "center"}
knitr::include_graphics("./Geocodificacion_files/img/02_SiGeo.jpg")
```
...
La información geográfica siempre está necesariamente ligada a un **Sistema de Referencia de Coordeanadas (_CRS_)**. Hay básicamente 2 grupos de _CRS_.
...
knitr::include_graphics("./Geocodificacion_files/img/vector_lonlat.png")
```
...
```{r, echo = FALSE, eval = TRUE, fig.asp = 2/2, out.width = "80%", fig.align = "center"}
knitr::include_graphics("./Geocodificacion_files/img/vector_projected.png")
```
...
- Rebajando la precisión de la coordenada devuelta por Cartociudad, `state = 6`, se geocodificó una oficina más.
...
knitr::include_graphics("./Geocodificacion_files/img/03_CoordenadasFuente.jpg")
```
...
```{r echo = FALSE, out.width = "100%", fig.height = 6, eval = require("leaflet")}
Oficinas <- sf::read_sf("./Geocodificacion_files/data/Oficinas2020geoIvie.gpkg") %>%
